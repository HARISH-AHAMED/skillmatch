...
function StarRating({ value, onChange, disabled }: { value: number; onChange: (v: number) => void; disabled?: boolean }) {
  ...
  return (
    <div className="flex gap-1">
      ...
      <span className="ml-2 text-sm font-medium text-[#333840] self-center">{value}/5</span>
    </div>
  );
}
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <motion.div
          className="absolute inset-0 bg-[#181d26]/40 backdrop-blur-xs"
          ...
          <div className="sticky top-0 z-10 bg-[#181d26] p-6 text-white border-b border-[#dddddd]">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h2 className="text-base font-normal leading-tight">{projectTitle}</h2>
              </div>
            </div>
