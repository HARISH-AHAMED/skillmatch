    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 py-16 w-full">
        <div className="text-center mb-16">
          ...
          <p className="text-[#5B6272] text-sm mt-3 max-w-xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="p-8 space-y-4">
            <div className="h-10 w-10 rounded-lg bg-[#2E6BEA]/10 flex items-center justify-center text-[#2159C9] border border-[#C7CBD6]/20">
          ...
          <Card className="p-8 space-y-4">
            <div className="h-10 w-10 rounded-lg bg-[#14713D]/10 flex items-center justify-center text-[#147A44] border border-[#BFE9D2]/20">
          ...
          <Card className="p-8 space-y-4">
            <div className="h-10 w-10 rounded-lg bg-[#96620A]/10 flex items-center justify-center text-[#8F5E08] border border-[#F5DEB0]/20">
          ...
          <Card className="p-8 space-y-4">
            <div className="h-10 w-10 rounded-lg bg-[#C22B2B]/10 flex items-center justify-center text-[#BC2A2A] border border-[#F5C2C2]/20">
