...
export default function FreelancerProfilePage() {
  ...
  const [hiddenCerts, setHiddenCerts] = useState<string[]>(
    () => certificatesFor(freelancer?.id ?? "", true).filter((c) => c.hidden).map((c) => c.id),
  );
            ...
            <div className="flex flex-col gap-5">
              ...
              <Card padding="none" className="overflow-hidden">
                <div className="relative h-32 bg-[var(--color-surface-sunken)] md:h-40">
                  <Image src={freelancer.bannerUrl} alt="" fill sizes="100vw" className="object-cover" />
                  <button
                    type="button"
                ...
                <div className="px-5 pb-5">
                  <div className="-mt-10 flex items-end gap-4">
                    <div className="relative">
                      <Avatar src={freelancer.avatarUrl} name={freelancer.name} size="2xl" ring />
                      <button
                        type="button"
              ...
              <Card padding="lg">
                ...
                <div className="rounded-[var(--radius-md)] border border-dashed border-[var(--color-border-emphasis)] bg-[var(--color-surface-alt)] p-6 text-center">
                  ...
                  <p className="mt-2.5 text-[13px] font-medium text-[var(--color-text-primary)]">
                    {freelancer.resumeUrl ? "Replace your resume" : "Upload your resume"}
                  </p>
                  ...
                  {freelancer.resumeUrl && (
                    <p className="mt-2 text-[12px] text-[var(--color-brand-active)]">
                      Current: {freelancer.resumeUrl.split("/").pop()}
                    </p>
                  )}
                </div>
              </Card>
