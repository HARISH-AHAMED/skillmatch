    ...
    <div className="min-h-screen flex flex-col justify-center items-center px-6 py-12 bg-white text-[#1A1D29]">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-normal text-[#1A1D29] tracking-tight">Welcome to Talentra</h1>
          <p className="text-xs text-[#5B6272]">Sign in to manage your projects or find matched tasks</p>
        </div>

        {/* Card containing login forms */}
        <Card className="p-8 border-[#C7CBD6] bg-white rounded-lg space-y-6">
          {error && (
          ...
          {/* OR divider */}
          <div className="flex items-center gap-4 text-xs font-medium text-[#5B6272]">
            <div className="h-[1px] bg-[#E8F1FE] flex-1" />
            <span>OR CONTINUE WITH</span>
            <div className="h-[1px] bg-[#FFF3DC] flex-1" />
          </div>
          ...
          <Button
            ...
            variant="outline"
            className="w-full gap-2 border-[#E3E5EA] hover:bg-[#F8F9FB] text-[#1A1D29] cursor-pointer"
            disabled={!!loading}
          >
            {loading === "google" ? (
              "Connecting..."
              ...
              <>
                <svg className="h-4 w-4 mr-1 fill-current text-[#1A1D29]" viewBox="0 0 24 24">
          ...
          <div className="border-t border-[#E3E5EA] pt-6 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                disabled={!!loading}
                className="flex flex-col items-center justify-center p-2.5 rounded-full border border-[#E3E5EA] bg-[#F8F9FB] hover:bg-[#E8F1FE] text-[#1A1D29] transition-all cursor-pointer"
              >
                <ShieldCheck className="h-4.5 w-4.5 text-[#1A1D29] mb-1" />
              ...
              <button
                ...
                disabled={!!loading}
                className="flex flex-col items-center justify-center p-2.5 rounded-full border border-[#C7CBD6] bg-[#F8F9FB] hover:bg-[#F0F3F9] text-[#1A1D29] transition-all cursor-pointer"
              >
                <Briefcase className="h-4.5 w-4.5 text-[#1A1D29] mb-1" />
              ...
              <button
                ...
                className="flex flex-col items-center justify-center p-2.5 rounded-full border border-[#E3E5EA] bg-[#F8F9FB] hover:bg-[#E8F1FE] text-[#1A1D29] transition-all cursor-pointer"
              >
                <UserCircle className="h-4.5 w-4.5 text-[#1A1D29] mb-1" />
                <span className="text-[11px] font-medium">Freelancer</span>
              </button>
            </div>
          </div>
        </Card>
