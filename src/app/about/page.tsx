      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-16 w-full space-y-12">
        ...
        <Card className="p-8 space-y-4">
          <div className="flex gap-4 items-start">
            <div className="h-10 w-10 rounded-lg bg-[#2E6BEA]/10 flex items-center justify-center text-[#2159C9] border border-[#C7CBD6]/20 mt-1 shrink-0">
              <Compass className="h-5 w-5" />
            </div>
            <div>
              <h3 className="text-lg font-bold">Our Vision</h3>
              <p className="text-xs text-[#5B6272] mt-1.5 leading-relaxed">
