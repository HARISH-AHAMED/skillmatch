...
export default function NewProjectPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      const errorMessage = err instanceof Error ? err.message : "Failed to create project listing.";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500 mt-1">
          Create a detailed project request sheet. Our AI engine will rank and recommend matches instantly.
        </p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex gap-4 pt-3">
              ...
              <Button type="submit" disabled={loading} className="w-2/3 cursor-pointer">
                {loading ? "Creating Listing..." : "Post Project Request"}
              </Button>
            </div>
          </form>
        </Card>
