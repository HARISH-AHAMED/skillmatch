...
export default async function CompanyWorkspacePage({ params }: PageProps) {
  ...
  // Fetch the application to check company permissions
  ...
  // Security Check: Does the company own the project?
  if (application.project.company.userId !== session.user.id) {
