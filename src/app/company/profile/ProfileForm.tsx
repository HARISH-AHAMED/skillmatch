...
export function ProfileForm({ initialData }: ProfileFormProps) {
  ...
  return (
    <Card className="p-8 w-full bg-white border border-[#dddddd] rounded-[12px] shadow-xs">
      {message && (
        <div
      ...
      <div className="bg-[#f8fafc] border border-[#dddddd] p-4 rounded-[10px] mb-6 space-y-2 text-left">
      ...
      {/* Tabs */}
      <div className="flex overflow-x-auto no-scrollbar border-b border-[#dddddd] gap-4 pb-2 mb-6 whitespace-nowrap scroll-smooth md:overflow-x-visible">
        {[
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {activeFormTab === "basic" && (
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-semibold text-slate-600">Company Description</label>
              <textarea
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <label className="block text-xs font-semibold text-slate-600">Founded Year</label>
                <input
                  type="number"
                  className="w-full px-4 py-2.5 rounded-xl text-sm transition-all focus:outline-none focus:ring-2 disabled:opacity-50 bg-white border border-slate-200 text-slate-800 focus:border-[#181d26] focus:ring-[#181d26]/20"
        ...
        {activeFormTab === "values" && (
          <div className="space-y-5">
            <div className="space-y-1.5">
              <label className="block text-xs font-semibold text-slate-600">Mission & Vision</label>
              <textarea
                className="w-full min-h-[100px] px-4 py-2.5 rounded-xl text-sm transition-all focus:outline-none focus:ring-2 disabled:opacity-50 bg-white border border-slate-200 text-slate-800 focus:border-[#181d26] focus:ring-[#181d26]/20"
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-semibold text-slate-600">Work Culture</label>
              <textarea
                className="w-full min-h-[100px] px-4 py-2.5 rounded-xl text-sm transition-all focus:outline-none focus:ring-2 disabled:opacity-50 bg-white border border-slate-200 text-slate-800 focus:border-[#181d26] focus:ring-[#181d26]/20"
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-semibold text-slate-600">Hiring Philosophy</label>
              <textarea
                className="w-full min-h-[100px] px-4 py-2.5 rounded-xl text-sm transition-all focus:outline-none focus:ring-2 disabled:opacity-50 bg-white border border-slate-200 text-slate-800 focus:border-[#181d26] focus:ring-[#181d26]/20"
          ...
          <div className="space-y-6">
                    ...
                    >
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="space-y-1 min-w-0 flex-1">
                          ...
                          <p className="text-[10px] text-slate-500 font-black uppercase tracking-wider">{member.role}</p>
                          {member.linkedinUrl && (
                            <a 
                              href={member.linkedinUrl} 
                              target="_blank" 
                              rel="noreferrer" 
                              className="text-[10px] text-[#1b61c9] font-bold hover:underline block"
                            >
                              LinkedIn Profile
                            </a>
                          )}
              ...
              <div className="p-4 bg-slate-50 border border-slate-200/60 rounded-2xl space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <div className="space-y-1.5 flex flex-col justify-end">
                    <label className="block text-[10px] font-bold text-slate-500 uppercase">Profile Photo</label>
                      ...
                      <label
                        ...
                        className={`inline-flex items-center gap-1.5 px-4.5 py-2.5 border rounded-xl text-[10px] font-bold cursor-pointer transition-colors ${
                          memberPhotoUploading 
                            ...
                            : "bg-white text-[#181d26] border-slate-200 hover:bg-slate-50 shadow-xs"
                        }`}
                      >
                ...
                <div className="space-y-1">
                  <label className="block text-[10px] font-bold text-slate-500 uppercase">Short Professional Bio</label>
                  <textarea
            ...
            <div className="space-y-4 border-t border-slate-100 pt-4">
              <div className="border-b border-slate-200 pb-2">
                ...
                <p className="text-[10px] text-slate-400 font-semibold">Upload photos of your workspace, office, team events, and culture</p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <label
                  ...
                  className={`inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-[10px] font-bold cursor-pointer shadow-sm transition-colors ${
                    galleryUploading ? "bg-slate-300 text-slate-500 cursor-not-allowed" : "bg-[#181d26] hover:bg-[#001f3f] text-white"
                  }`}
                >
                  <Upload className="h-3.5 w-3.5" />
            ...
            <div className="grid grid-cols-2 gap-4">
              {availableBadges.map((badge) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <ShieldCheck className={`h-5 w-5 ${isActive ? "text-[#1b61c9]" : "text-slate-300"}`} />
                      <span className="text-xs">{badge}</span>
                    </div>
                    <div
                      className={`h-4.5 w-4.5 rounded-full border flex items-center justify-center ${
                        isActive ? "bg-[#1b61c9] border-[#1b61c9]" : "border-slate-300"
                      }`}
                    >
